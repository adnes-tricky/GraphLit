...
import type { DefineComponent, WatchStopHandle, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps, ExtractPropTypes, PropType as __PropType } from 'vue';
import type { StrokeStyle, EdgeLabelStyle } from '../../common/configs';
import { Edges } from '../../common/types';
declare const _sfc_main: DefineComponent<{
    edges: {
        type: __PropType<Edges>;
        required: true;
    };
    config: {
        type: __PropType<EdgeLabelStyle>;
        required: true;
    };
    state: {
        type: __PropType<{
