...
import type { isSummarizedEdges } from '../../composables/state';
import type { Layouts, EdgeConfig, Edge, LabelStyle, ShapeStyle, StrokeStyle, LinePosition, EdgePosition, Vector2D, Point } from '../..';
import type { EdgeStates, EdgeGroupStates, EdgeEntry, Line } from '../../models/edge';
import type { DefineComponent, Slot, ComputedRef, Ref, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps, ExtractPropTypes, WatchStopHandle } from 'vue';
