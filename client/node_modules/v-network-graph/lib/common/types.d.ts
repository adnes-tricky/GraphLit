...
export declare type LayerName = "edges" | "edge-labels" | "focusring" | "nodes" | "node-labels" | "paths";
export declare type LayerPosition = LayerName | "base" | "grid" | "background" | "root";
export declare type Layers = Record<string, LayerPosition>;
export declare const LayerPositions: readonly LayerPosition[];
export declare type ViewMode = "default" | "node" | "edge" | "path" | "box-selection";
...
export declare type PositionOrCurve = Position | Position[] | string | null;
