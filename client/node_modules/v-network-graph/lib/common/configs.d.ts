...
export declare type ShapeStyleBase = BasicShapeStyle;
...
export declare type OppositeNodes = Record<string, OppositeNode>;
export interface NodeLabelDirectionHandlerParams {
    nodeId: string;
    pos: Position;
    oppositeNodes: OppositeNodes;
}
export declare type NodeLabelDirectionAutoAdjustmentHandler = (params: NodeLabelDirectionHandlerParams) => NodeLabelDirectionType | null;
