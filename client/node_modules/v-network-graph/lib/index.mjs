...
var le = Math.pow, Kn = (e, t, n) => t in e ? dr(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, re = (e, t) => {
  for (var n in t || (t = {}))
...
import { isReactive as gr, reactive as Ce, provide as je, inject as Be, watch as G, toRef as Te, watchEffect as ge, computed as O, unref as y, ref as Z, onMounted as rt, onUnmounted as bt, nextTick as cn, defineComponent as W, openBlock as M, createElementBlock as I, createBlock as H, resolveDynamicComponent as mr, createCommentVNode as ce, Fragment as X, renderList as ee, mergeProps as Se, renderSlot as K, normalizeClass as ve, withModifiers as Ee, normalizeStyle as yt, useAttrs as br, createElementVNode as Vo, createTextVNode as yr, toDisplayString as Yn, createVNode as Fe, withCtx as ne, normalizeProps as ue, guardReactiveProps as de, useSlots as Zt, createSlots as Wo, TransitionGroup as ht, toHandlers as wr, readonly as at } from "vue";
const xr = [
  "paths",
  "node-labels",
  "nodes",
...
var zs = _s();
const Is = zs;
var Xo = typeof exports == "object" && exports && !exports.nodeType && exports, eo = Xo && typeof module == "object" && module && !module.nodeType && module, As = eo && eo.exports === Xo, to = As ? we.Buffer : void 0, no = to ? to.allocUnsafe : void 0;
function Ls(e, t) {
  if (t)
    return e.slice();
...
var Jo = typeof exports == "object" && exports && !exports.nodeType && exports, ro = Jo && typeof module == "object" && module && !module.nodeType && module, Js = ro && ro.exports === Jo, so = Js ? we.Buffer : void 0, ea = so ? so.isBuffer : void 0, ta = ea || Qs;
const It = ta;
...
var ni = typeof exports == "object" && exports && !exports.nodeType && exports, dt = ni && typeof module == "object" && module && !module.nodeType && module, Ia = dt && dt.exports === ni, en = Ia && Uo.process, Aa = function() {
  try {
...
function ii(e, t) {
  var n = Ge(e), o = !n && dn(e), i = !n && !o && It(e), r = !n && !o && !i && Mn(e), s = n || o || i || r, a = s ? Ba(e.length, String) : [], l = a.length;
  for (var u in e)
    (t || Wa.call(e, u)) && !(s && (u == "length" || i && (u == "offset" || u == "parent") || r && (u == "buffer" || u == "byteLength" || u == "byteOffset") || oi(u, l))) && a.push(u);
  return a;
}
function Fa(e) {
  var t = [];
...
function Ka(e, t, n, o, i, r, s) {
  ...
  if (f) {
    var d = Ge(l), v = !d && It(l), x = !d && !v && Mn(l);
...
function ai(e, t, n) {
  if (!ke(n))
    return !1;
  var o = typeof t;
  return (o == "number" ? Rt(n) && oi(t, n.length) : o == "string" && t in n) ? wt(n[t], e) : !1;
}
function li(e) {
...
var kl = we.isFinite, Ml = Math.min;
function Tl(e) {
  var t = Math[e];
  return function(n, o) {
    if (n = At(n), o = o == null ? 0 : Ml(di(o), 292), o && kl(n)) {
...
class hi {
  activate(t) {
    const { nodePositions: n, nodes: o, configs: i, emitter: r, scale: s, svgPanZoom: a } = t, l = (f) => {
      ...
      for (const P of d) {
        const E = o.value[P], p = mo(E, i.node, x), m = re({}, v.center);
        for (; ; ) {
          let b = !1;
...
var Hl = 1, Vl = 2, Wl = "[object Boolean]", Fl = "[object Date]", Ul = "[object Error]", Gl = "[object Map]", Xl = "[object Number]", ql = "[object RegExp]", Kl = "[object Set]", Yl = "[object String]", Ql = "[object Symbol]", Jl = "[object ArrayBuffer]", ec = "[object DataView]", yo = De ? De.prototype : void 0, nn = yo ? yo.valueOf : void 0;
function tc(e, t, n, o, i, r, s) {
  switch (n) {
    ...
    case Jl:
      return !(e.byteLength != t.byteLength || !r(new zt(e), new zt(t)));
    case Wl:
    case Fl:
    case Xl:
      return wt(+e, +t);
...
var wc = Ke(we, "DataView");
const hn = wc;
var xc = Ke(we, "Promise");
const vn = xc;
var Ec = Ke(we, "Set");
const nt = Ec;
var Pc = Ke(we, "WeakMap");
const pn = Pc;
...
function Ic(e, t, n) {
  ...
  return ge(() => {
    ...
    Ct(o.edgeLayoutPoints, i), Ct(o.edgeGroups, r);
  }), ge(() => {
    const i = {};
...
function Ft(e, t, n, o) {
  ...
  if (o === l)
    return a;
  const u = Math.sqrt(le(o, 2) - le(l, 2)), c = s.v.normalize().multiplyScalar(u);
  return a.subtract(c);
}
function Vc(e, t, n, o, i) {
  ...
  if (o === u)
    return l;
  const c = Math.sqrt(le(o, 2) - le(u, 2)), f = a.v.normalize().multiplyScalar(c), d = l.clone().add(f), v = l.clone().subtract(f), x = i.distance(d), P = i.distance(v);
...
function mt(e, t, n, o, i) {
  ...
  const f = t, d = o, v = (le(l, 2) + le(f, 2) - le(d, 2)) / (2 * l * f), x = f * v, P = Math.sqrt(le(f, 2) - le(x, 2)), E = a.clone().normalize(), p = new R(-E.y, E.x), m = E.clone().multiplyScalar(x), w = p.clone().multiplyScalar(P), b = e.clone().add(m).add(w), h = e.clone().add(m).subtract(w);
  if (i) {
...
function Ao(e, t, n, o) {
  ...
  if (d || v || a === 0)
    return Math.sqrt(d ? le(s, 2) + le(c, 2) : le(r, 2) + le(f, 2));
  {
    const x = t.x - r + a, P = t.y - s + a, E = t.x + r - a, p = t.y + s - a, m = [
      ...
      new R(E, p),
      new R(x, p)
    ], w = Math.floor((i.v.angleDegree() + 360) % 360 / 90), b = m[w], h = Ft(
      i.source,
      Nn(b, i),
      b,
      a
...
function ou(e, t, n, o, i, r) {
  n.shape = O(() => e.value[t] ? nu(e.value[t], n.selected, n.hovered, o) : y(n.shape)), n.staticShape = O(() => e.value[t] ? Ci(e.value[t], n.selected, o) : y(n.staticShape)), n.label = O(() => e.value[t] ? z.values(o.label, e.value[t]) : y(n.label)), n.labelText = O(() => {
    ...
    return c && (s[l] = { nodeId: u, pos: re({}, c) }), s;
  }, {}));
}
function iu(e, t, n, o) {
...
function ru(e, t, n, o, i, r, s, a, l, u) {
  ...
  const v = Te(
    ...
    if (A.source.type !== "none") {
      const ae = A.source;
      C = ae.margin + ae.width, ae.units === "strokeWidth" && (C *= A.normalWidth);
    }
    if (A.target.type !== "none") {
      const ae = A.target;
      $ = ae.margin + ae.width, ae.units === "strokeWidth" && ($ *= A.normalWidth);
    }
    o.margin && (C += o.margin, $ += o.margin);
    const B = !!o.margin || A.source.type !== "none" || A.target.type !== "none";
    if (p.source === p.target) {
      n.origin = Nt(m, w);
      const ae = z.values(o.selfLoop, p), [Qe, Je] = lu(
        m,
        b,
        ae,
        B,
    ...
    if (B && (C += k, $ += T), o.type === "straight")
      ...
      n.origin = Nt(m, w);
      const ae = v.value ? v.value.groupWidth / 2 - v.value.pointInGroup : 0, [Qe, Je] = au(
        n.origin,
        g,
        ae,
        C * _,
...
function lu(e, t, n, o, i, r, s, a) {
  ...
  if (x === void 0 || P === void 0) {
    ...
    let h = 1 * (Math.PI / 180);
    v || (h *= -1), x = d.clone().add(Lt(b, h)), P = d.clone().add(Lt(b, -h));
  }
...
function fu(e, t, n, o, i, r, s) {
  ...
  function u(b) {
    ...
    if (h || g) {
      ...
      a.follow.nodeBasePositions = Object.fromEntries(
        ...
        }).map((_) => [_, sn(t.nodes, _)])
      ), b.dragBasePosition = re({}, b.latestPosition), b.nodeBasePosition = sn(t.nodes, b.nodeId);
    }
  }
  G(i, (b) => {
  ...
  function c(b, h) {
    const g = b.dragBasePosition.x - h.pageX, k = b.dragBasePosition.y - h.pageY, T = a.follow.followedPointerId == b.pointerId ? re({
  ...
  function x(b) {
    ...
    if (h) {
      for (h of a.pointers.values()) {
        const g = h.nodeId, k = $t(b.pointerType);
        if (h.moveCounter > k) {
          const _ = c(h, {
            pointerId: h.pointerId,
      ...
      a.pointers.clear(), a.follow = { followedPointerId: -1, nodeBasePositions: {} }, he(l).forEach(([g, k]) => {
  ...
  function P(b) {
    ...
    const g = h.nodeId, k = $t(b.pointerType), T = h.moveCounter > k;
    if (T) {
    ...
    a.pointers.size === 0 ? (a.follow = { followedPointerId: -1, nodeBasePositions: {} }, he(l).forEach(([A, B]) => {
  ...
  function E(b, h) {
    if (h.button == 2 || (h.stopPropagation(), !["default", "node"].includes(n.viewMode.value)))
      return;
    a.pointers.size == 0 && (n.viewMode.value = "node", he(l).forEach(([k, T]) => {
...
function hu(e, t, n, o, i) {
  ...
  function a(h, g) {
    if (g.button == 2 || (g.stopPropagation(), !["default", "edge"].includes(t.viewMode.value)))
      return;
    r.pointers.size == 0 && (t.viewMode.value = "edge", he(s).forEach(([T, _]) => {
    ...
    r.pointers.set(g.pointerId, k), i.emit("edge:pointerdown", ye(h, g));
  }
  function l(h) {
    var C, $;
    h.stopPropagation();
    ...
    (C = g.eventTarget) == null || C.dispatchEvent(T), _ && (($ = g.eventTarget) == null || $.dispatchEvent(_)), r.pointers.size === 0 && (r.pointerPeekCount = 0, he(s).forEach(([A, B]) => {
      document.removeEventListener(A, B);
  ...
  function u(h) {
    if (h.stopPropagation(), !!r.pointers.get(h.pointerId)) {
      for (const k of r.pointers.values()) {
        const T = k.id;
        i.emit("edge:pointerup", ye(T, h));
      }
      r.pointers.clear(), r.pointerPeekCount = 0, he(s).forEach(([k, T]) => {
  ...
  function c(h, g) {
    ...
    i.emit("edge:click", ye(h, g));
  }
  function f(h, g) {
    g.isTrusted || i.emit("edge:dblclick", ye(h, g));
  }
  function d(h, g) {
    n.add(h), i.emit("edge:pointerover", ye(h, g));
  }
  function v(h, g) {
    n.delete(h), i.emit("edge:pointerout", ye(h, g));
  }
  function x(h, g) {
    g.stopPropagation(), i.emit("edge:contextmenu", ye(h, g));
  }
  function P(h, g) {
    if (g.button == 2 || (g.stopPropagation(), !["default", "edge"].includes(t.viewMode.value)))
      return;
  ...
  function E(h, g) {
    h.forEach((k) => n.add(k)), i.emit("edge:pointerover", ye(h, g));
  }
  function p(h, g) {
    h.forEach((k) => n.delete(k)), i.emit("edge:pointerout", ye(h, g));
  }
  function m(h, g) {
    c(h, g);
  }
...
function vu(e, t, n, o) {
  ...
  function s(v) {
    i.moveCounter = 0, i.pointerCounter === 0 && he(r).forEach(([x, P]) => {
  ...
  function l(v) {
    if (i.pointerCounter--, i.pointerCounter <= 0) {
      i.pointerCounter = 0, he(r).forEach(([P, E]) => {
        document.removeEventListener(P, E);
      });
      const x = $t(v.pointerType);
      if (i.moveCounter <= x) {
  ...
  function f(v) {
    o.emit("view:contextmenu", { event: v }), i.pointerCounter > 0 && (i.pointerCounter = 0, he(r).forEach(([x, P]) => {
      var E;
...
function pu(e, t, n, o, i, r) {
  ...
  function u(p, m) {
    ...
    if (!((b = e[p]) != null && b.clickable) || m.button == 2 || (m.stopPropagation(), !["default", "path"].includes(t.viewMode.value)))
      return;
    s.pointers.size == 0 && (t.viewMode.value = "path", he(l).forEach(([h, g]) => {
  ...
  function c(p) {
    ...
    (g = m.eventTarget) == null || g.dispatchEvent(b), h && ((k = m.eventTarget) == null || k.dispatchEvent(h)), s.pointers.size === 0 && (s.pointerPeekCount = 0, he(l).forEach(([T, _]) => {
  ...
  function f(p) {
    if (s.pointers.get(p.pointerId)) {
      ...
      s.pointers.clear(), s.pointerPeekCount = 0, he(l).forEach(([w, b]) => {
...
function Cu(e, t, n) {
  ...
  t = At(t) || 0, ke(n) && (c = !!n.leading, f = "maxWait" in n, r = f ? Tu(At(n.maxWait) || 0, t) : r, d = "trailing" in n ? !!n.trailing : d);
  function v(g) {
    var k = o, T = i;
...
var Dt = typeof globalThis != "undefined" ? globalThis : typeof window != "undefined" ? window : typeof global != "undefined" ? global : typeof self != "undefined" ? self : {}, Ut = {
...
var Ju = function(e, t) {
  return new oe(e, t);
}, Ni = Ku, wn = Yu, fe = Ut, se = Bn, ed = Ju, U = function(e, t) {
  this.init(e, t);
}, td = {
...
U.prototype.init = function(e, t) {
  var n = this;
  this.svg = e, this.defs = e.querySelector("defs"), se.setupSvgAttributes(this.svg), this.options = fe.extend(fe.extend({}, td), t), this.state = "none";
  var o = se.getBoundingClientRectNormalized(e);
  this.width = o.width, this.height = o.height, this.viewport = ed(
    se.getOrCreateViewport(this.svg, this.options.viewportSelector),
    {
      svg: this.svg,
      width: this.width,
      height: this.height,
...
U.prototype.handleMouseWheel = function(e) {
  if (!(!this.options.zoomEnabled || this.state !== "none")) {
    ...
    var i = this.svg.getScreenCTM().inverse(), r = se.getEventPoint(e, this.svg).matrixTransform(
      i
...
U.prototype.zoom = function(e, t) {
  this.zoomAtPoint(
    e,
    se.getSvgCenterPoint(this.svg, this.width, this.height),
    t
  );
};
...
U.prototype.publicZoomAtPoint = function(e, t, n) {
  if (n && (e = this.computeFromRelativeZoom(e)), fe.getType(t) !== "SVGPoint")
    if ("x" in t && "y" in t)
      t = se.createSVGPoint(this.svg, t.x, t.y);
    else
...
U.prototype.handleMouseMove = function(e) {
  if (this.options.preventMouseEventsDefault && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), this.state === "pan" && this.options.panEnabled) {
    var t = se.getEventPoint(e, this.svg).matrixTransform(
      this.firstEventCTM.inverse()
...
U.prototype.handleTouchStart = function(e, t) {
  if (e.touches.length == 1)
    ...
    var n = se.getTouchPoint(e, this.svg, 0), o = se.getTouchPoint(e, this.svg, 1);
...
U.prototype.handleTouchMove = function(e) {
  if (e.touches.length == 1)
    ...
    if (this.options.preventMouseEventsDefault && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), !this.options.panEnabled && !this.options.zoomEnabled)
      return;
    var t = se.getTouchPoint(e, this.svg, 0), n = se.getTouchPoint(e, this.svg, 1), o = this.svg.createSVGPoint();
    ...
    if (this.options.zoomEnabled) {
      var s = fe.calculateDistance(t, n), a = s / this.firstDistance, l = this.svg.getScreenCTM().inverse(), u = o.matrixTransform(l);
...
U.prototype.handleTouchEnd = function(e) {
  if (e.touches.length == 0)
    ...
    this.stateOrigin = se.getEventPoint(e, this.svg).matrixTransform(
      this.firstEventCTM.inverse()
    );
  else {
    var t = se.getTouchPoint(e, this.svg, 0), n = se.getTouchPoint(e, this.svg, 1);
...
U.prototype.resize = function() {
  var e = se.getBoundingClientRectNormalized(
    this.svg
  );
...
const xd = ["points", "fill"], Ed = /* @__PURE__ */ W({
  ...
  setup(e) {
    const { container: t, svgPanZoom: n } = En(), { zoomLevel: o } = me(), i = Xu(), r = zl(), s = Z({ x: 0, y: 0 }), a = Z({ width: 500, height: 500 });
    rt(() => {
      var x;
    ...
    return ge(() => {
      ...
      $ = re({}, $), $["stroke-dashoffset"] = C ? w / E : void 0, A = re({}, A), A["stroke-dashoffset"] = _ ? w / E : void 0;
...
const Zd = /* @__PURE__ */ W({
  ...
  setup(e) {
    ...
    return (i, r) => (M(!0), I(X, null, ee(y(n).edgeGroups, ({ summarize: s, edges: a }) => (M(), I(X, null, [
      s ? ce("", !0) : (M(!0), I(X, { key: 0 }, ee(a, (l, u) => (M(), H(Dd, {
        key: u,
        id: u,
        state: y(t)[u],
  ...
  setup(e) {
    const t = e, { scale: n } = me(), o = O(() => t.config.width * n.value), i = O(() => xt(t.config.dasharray, n.value)), r = O(() => {
      const s = t.config.animate ? Ht(t.config.dasharray) * t.config.animationSpeed * n.value : !1;
...
const Fd = ["cx", "cy", "r", "fill", "stroke", "stroke-width", "stroke-dasharray"], Ud = ["x", "y", "width", "height", "rx", "ry", "fill", "stroke", "stroke-width", "stroke-dasharray"], Gt = /* @__PURE__ */ W({
  __name: "VShape",
  props: {
    baseX: { default: 0 },
    baseY: { default: 0 },
  ...
  setup(e) {
    const t = e, { scale: n } = me(), o = Z(t.baseX), i = Z(t.baseY), r = Z(0), s = Z("#000000"), a = Z(void 0), l = Z(0), u = Z(0), c = Z(0), f = Z(0);
    return ge(() => {
      var v;
      const d = n.value;
...
}), Gd = ["rx", "ry", "fill", "transform"], Xd = ["x", "y", "dominant-baseline", "font-family", "font-size", "fill"], qd = ["x", "dy", "dominant-baseline"], Xt = /* @__PURE__ */ W({
  __name: "VLabelText",
  props: {
    text: null,
    x: { default: 0 },
  ...
  setup(e) {
    ...
    return (w, b) => (M(), I("g", {
      class: ve({ "v-ng-line-summarized": !0, hovered: y(E), selectable: y(p), selected: y(m) }),
...
const Yd = { class: "v-ng-edge-overlay" }, Do = /* @__PURE__ */ W({
  ...
  setup(e) {
    const t = e, { svg: n } = En(), { scale: o } = me(), i = Et();
    function r() {
  ...
  __name: "VEdgesLayer",
  setup(e) {
    const t = Zt(), n = O(() => "edge-overlay" in t);
    return (o, i) => (M(), I("g", Jd, [
      Fe(Zd),
      Fe(Qd, { "has-edge-overlay-slot": y(n) }, Wo({ _: 2 }, [
        y(n) ? {
          name: "default",
          fn: ne((r) => [
            K(o.$slots, "edge-overlay", ue(de(r)))
          ]),
          key: "0"
        } : void 0
  ...
  setup(e) {
    ...
    return (i, r) => e.state.loop ? ce("", !0) : K(i.$slots, "default", {
      key: 0,
      edgeId: e.edgeId,
      edge: e.edge,
      config: e.config,
  ...
  setup(e) {
    ...
    return (a, l) => (M(), I("g", of, [
      ...
      e.enableEdgesLabel ? (M(!0), I(X, { key: 1 }, ee(y(r).summarized, (u, c) => (M(), H(nf, {
        ...
        default: ne((f) => [
          K(a.$slots, "edges-label", ue(de(f)))
        ]),
        _: 2
      }, 1032, ["edges", "config", "state", "summarize-state"]))), 128)) : ce("", !0)
    ]));
  }
});
const sf = /* @__PURE__ */ W({
...
const df = /* @__PURE__ */ W({
  __name: "VNodesLayer",
  setup(e) {
    const t = Zt(), n = O(() => "override-node" in t), { nodeZOrderedList: o } = Me(), i = Wt(), r = Rn();
    return (s, a) => y(n) ? (M(), H(ht, {
      ...
      default: ne(() => [
        (M(!0), I(X, null, ee(y(o), (l) => (M(), H(Zo, {
          ...
          "override-node": ne((u) => [
            K(s.$slots, "override-node", ue(de(u)))
          ]),
          _: 2
...
const gf = ["transform"], jo = /* @__PURE__ */ W({
  ...
  setup(e) {
    const t = e, n = Wt(), { edgeStates: o } = Me(), { scale: i } = me(), {
      handleNodePointerDownEvent: r,
      handleNodePointerOverEvent: s,
      handleNodePointerOutEvent: a,
      handleNodeClickEvent: l,
    ...
    ge(() => {
      ...
      if ($.type == "circle") {
        const A = $.radius * C, B = A + v.value, Y = Math.sqrt(le(B, 2) / 2);
        x.value = A + v.value, P.value = A + v.value, E.value = Y, p.value = Y;
      } else {
        const A = $.borderRadius * C, B = $.width * C, Y = $.height * C, j = A + v.value, F = Math.sqrt(le(j, 2) / 2);
...
const mf = /* @__PURE__ */ W({
  ...
  setup(e) {
    const t = Zt(), n = O(() => "override-node-label" in t), { nodeZOrderedList: o } = Me(), i = Wt(), r = Rn(), s = O(() => a(o.value));
    function a(l) {
      return l.filter((u) => {
        var c;
      ...
      default: ne(() => [
        (M(!0), I(X, null, ee(y(s), (c) => (M(), H(jo, {
          ...
          "override-node-label": ne((f) => [
            K(l.$slots, "override-node-label", ue(de(f)))
          ]),
          _: 2
        }, 1032, ["id", "state", "pos"]))), 128))
      ]),
  ...
  for (let p = 1; p < x; p++) {
    ...
    if (g) {
      ...
      if (F < T)
        ...
        let be, ie;
        B && $ ? be = te.distance(g, $) < te.distance(g, B) ? $ : B : be = B || m.line.target, Y && A ? ie = te.distance(g, A) < te.distance(g, Y) ? A : Y : ie = Y || w.line.source, j = [be, g, ie];
      } else
    ...
    if (m.curve) {
      ...
      if (F) {
        const be = F instanceof Array ? F[F.length - 1] : F;
        let ie;
      ...
      const [F, be, ie] = Ho(h, m, k);
      f.push(F), f.push(ie), j instanceof Array && r ? f.push([be, j[1], j[2]]) : f.push(j[2]);
    } else
...
function Ef(e, t, n) {
  ...
  const a = n.loop;
  a ? o = n.position : t || (o = Hc(o), i = e.edge.target, r = e.edge.source, s && (s = st(re({}, s), { theta: -s.theta })));
...
const Pf = ["d", "stroke", "stroke-width", "stroke-dasharray", "stroke-linecap", "stroke-linejoin"], Sf = /* @__PURE__ */ W({
  ...
  setup(e) {
    const t = e, { nodeStates: n, edgeStates: o, layouts: i } = Me(), { scale: r } = me(), s = gi();
    function a(d) {
      if (d.edges.length === 0)
        return [];
    ...
    const u = O(() => {
      ...
      const d = u.value.animate ? Ht(u.value.dasharray) * u.value.animationSpeed * r.value : !1;
...
const kf = /* @__PURE__ */ W({
  ...
  setup(e, { expose: t, emit: n }) {
    const o = e, i = [
      ...
      "edge-label",
      "edges-label"
    ], r = Zt(), s = Te(o, "nodes"), a = Te(o, "edges"), { objects: l, isInCompatibilityModeForPath: u } = dd(
      Te(o, "paths")
    ), c = Gu();
    ...
    const f = _l(Te(o, "configs")), d = O(() => {
      ...
      return Object.assign(
        L,
        Object.entries(o.layers).reduce((D, [V, xe]) => (S.delete(V), xe in D ? D[xe].push(V) : D[xe] = [V], D), {})
      ), L.root.push(...S), L;
    }), v = O(() => f.view.grid.visible), x = O(() => {
      const S = d.value;
      return v.value || S.background.length > 0 || S.grid.length > 0;
    }), P = bd(f, r), E = Z(), p = Z(), m = Z(), w = Z(0), b = O(() => w.value !== 0), h = fd(o, "zoomLevel", n, (S) => (S = Math.max(S, f.view.minZoomLevel), S = Math.min(S, f.view.maxZoomLevel), S)), { svgPanZoom: g, onSvgPanZoomMounted: k, onSvgPanZoomUnmounted: T } = ad(p, {
      viewportSelector: ".v-ng-viewport",
      minZoom: f.view.minZoomLevel,
      maxZoom: f.view.maxZoomLevel,
      dblClickZoomEnabled: Gn(f.view),
      mouseWheelZoomEnabled: Yt(f.view),
      fit: !0,
      center: !0,
    ...
    const _ = { width: 0, height: 0 }, C = globalThis.ResizeObserver ? new ResizeObserver(() => {
      ...
      if (S) {
        const xe = -(_.width - S.width) / 2, St = -(_.height - S.height) / 2;
        (V = g.value) == null || V.panBy({ x: xe, y: St });
        const { width: et, height: Qt } = S;
        (_.width !== et || _.height !== Qt) && (Object.assign(_, { width: et, height: Qt }), c.emit("view:resize", { x: S.x, y: S.y, width: et, height: Qt }));
      }
    }) : void 0;
    k(() => {
      var xe, St, et;
      const S = q(E.value, "svg-pan-zoom container");
      C == null || C.observe(S), (St = (xe = f.view).onSvgPanZoomInitialized) == null || St.call(xe, q(g.value, "svg-pan-zoom instance"));
    ...
    const B = (S) => {
      var L;
      Object.keys(o.nodes).length > 0 ? ((L = g.value) == null || L.updateBBox(), cn(S)) : S();
    }, Y = () => {
      B(() => {
    ...
    }, ie = ln(o, "selectedNodes", s, n);
    G(ie, (S) => c.emit("node:select", Array.from(S)));
    const Pe = ln(o, "selectedEdges", a, n);
    G(Pe, (S) => c.emit("edge:select", Array.from(S)));
    const ae = ln(o, "selectedPaths", l, n);
    G(ae, (S) => c.emit("path:select", Array.from(S))), hd(ie, Pe, ae);
    ...
    const qt = qc(), Kt = Z(!1);
    c.on("node:dragstart", (S) => Kt.value = !0), c.on("node:dragend", (S) => Kt.value = !1), c.on("view:mode", (S) => {
      var L, D, V, xe;
      f.view.panEnabled && (S === "default" ? (L = g.value) == null || L.enablePan() : (D = g.value) == null || D.disablePan()), f.view.zoomEnabled && (S === "default" ? (V = g.value) == null || V.enableZoom() : (xe = g.value) == null || xe.disableZoom());
    });
    const Wi = O(() => f.view.panEnabled || f.view.zoomEnabled || f.node.draggable), { nodeStates: Fi, edgeStates: Ui, pathStates: Gi } = eu(
      ...
      qt,
      A
    ), Xi = O(() => Yt(f.view)), { isBoxSelectionMode: qi, selectionBox: Vn, startBoxSelection: Ki, stopBoxSelection: Yi } = Fu(
      p,
      at(_e),
      at(h),
      Fi,
    ...
    k(() => {
      B(() => {
        ...
        f.view.layoutHandler.activate(Wn()), cn(() => {
          const L = f.view.autoPanAndZoomOnLoad;
          if (f.view.fit || L !== !1)
            if (Object.keys(o.nodes).length == 0 || L === "center-zero") {
              const V = S.getSizes();
              S.pan({
                x: V.width / 2,
                y: V.height / 2
    ...
    return (S, L) => (M(), I("div", {
      ...
      (M(), I("svg", {
        ref_key: "svg",
        ref: p,
        class: ve(["v-ng-canvas", { show: y(b), dragging: Kt.value, touches: y(Wi), "box-selection-mode": y(qi) }]),
        width: "100%",
        height: "100%"
      }, [
        ...
        Object.keys(y(qt).markers).length > 0 ? (M(), I("defs", Tf, [
          (M(!0), I(X, null, ee(y(qt).markers, (D, V) => (M(), H(Od, {
            id: V,
            key: V,
            marker: D,
            scale: y(A)
        ...
        Vo("g", {
          ref_key: "viewport",
          ref: m,
          class: ve(["v-ng-viewport", { "v-ng-transition": y(Fn).enabled }]),
          style: yt(y(Ji))
        }, [
          ...
          (M(!0), I(X, null, ee(y(P), (D) => (M(), I(X, { key: D }, [
            D === "edges" ? (M(), H(ef, { key: 0 }, {
              "edge-overlay": ne((V) => [
                K(S.$slots, "edge-overlay", ue(de(V)))
              ]),
              _: 3
              ...
              "edge-label": ne((V) => [
                K(S.$slots, "edge-label", ue(de(V)))
              ]),
              "edges-label": ne((V) => [
                K(S.$slots, "edges-label", ue(de(V)))
              ]),
              _: 3
            }, 8, ["enable-edge-label", "enable-edges-label"])) : D === "focusring" ? (M(), H(cf, { key: 2 })) : D === "nodes" ? (M(), H(df, { key: 3 }, {
              "override-node": ne((V) => [
                K(S.$slots, "override-node", ue(de(V)))
              ]),
              _: 3
            })) : D === "node-labels" ? (M(), H(mf, { key: 4 }, {
              "override-node-label": ne((V) => [
                K(S.$slots, "override-node-label", ue(de(V)))
              ]),
              _: 3
            })) : D === "paths" ? (M(), H(Mf, { key: 5 })) : ce("", !0),
...
const Cf = /* @__PURE__ */ W({
  ...
  setup(e) {
    ...
    const a = O(() => r.value === "central" && !t.config.background ? st(re({}, t.config), {
      background: {
        visible: !0,
        color: "#ffffff",
        padding: {
